...
class TypeScriptLanguageClient extends AutoLanguageClient {
  ...
  startServerProcess () {
    ...
    // TODO: Newer versions of `typescript-language-server` require Node 18,
    // meaning we'd either need to wait for an Electron upgrade or move to a
    // bring-your-own-node model.
